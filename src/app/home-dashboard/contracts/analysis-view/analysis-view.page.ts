...
@Component({
  ...
  templateUrl: './analysis-view.page.html',
  styleUrls: ['./analysis-view.page.scss'],
})
export class AnalysisViewPage implements OnInit, OnDestroy {
  ...
  addictionDisplayed = false;
  deletionDisplayed = false;
  ...
  arrow(event) {
    if(event.target.id == 'addiction')
    {
      this.addictionDisplayed = !this.addictionDisplayed;
      document.getElementById('addictionHeader').style.display = this.addictionDisplayed ? 'flex' : 'block';
    }
    else if(event.target.id == 'deletion')
    {
      this.deletionDisplayed = !this.deletionDisplayed;
      document.getElementById('deletionHeader').style.display = this.deletionDisplayed ? 'flex' : 'block';
    }
    else if(event.target.id == 'comment')
    {
      this.commentDisplayed = !this.commentDisplayed;
      document.getElementById('commentHeader').style.display = this.commentDisplayed ? 'flex' : 'block';
    }
    else
    {
